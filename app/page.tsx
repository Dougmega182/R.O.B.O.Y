  ...
  return (
    <div className="h-screen flex bg-[#f8f9fa] text-gray-800 font-sans overflow-hidden relative">
      ...
      <nav 
        ...
        className={`bg-white border-r border-gray-100 flex-col flex-shrink-0 transition-all duration-300 ease-in-out z-50 print:hidden hidden md:flex ${
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        <header className="h-16 bg-white border-b border-gray-100 flex items-center justify-between px-4 md:px-8 shrink-0 relative print:hidden">
          <div className="flex items-center gap-3">
            <button
              onClick={() => setActiveView("chatgpt")}
              className="inline-flex items-center rounded-xl bg-slate-900 px-3 md:px-4 py-2 text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-white transition-all hover:bg-black"
            >
              <span className="hidden md:inline">Ask ChatGPT</span>
              <span className="md:hidden">AI</span>
            </button>
          </div>
          <div className="flex flex-col items-center absolute left-1/2 -translate-x-1/2">
            <div className="text-[14px] md:text-[16px] font-black text-blue-600 uppercase tracking-[0.4em] leading-none">R.O.B.O.Y</div>
            <div className="text-[8px] font-black text-gray-400 uppercase tracking-[0.2em] mt-1 hidden md:block">Run Our Base, Own Your Year</div>
          </div>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-white border-t border-gray-100 flex items-center justify-around px-2 z-50 shadow-2xl">
        {[
          { id: "home" as View, label: "Home", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg> },
          { id: "calendar" as View, label: "Cal", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="10" x2="21" y2="10"></line></svg> },
          { id: "timetable" as View, label: "Time", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="3" x2="9" y2="21"></line></svg> },
          { id: "meals" as View, label: "Meals", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path></svg> },
          { id: "tasks" as View, label: "Jobs", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg> },
